...
> Download images, GIFs, and videos from X (Twitter) using browser cookies.  
> **No Developer Account, no API Key required.**
...
<!--
  💡 Add a screenshot or demo GIF here to help users quickly understand the tool.
  Example:
  ![xdl gallery demo](docs/demo.gif)
  ![xdl CLI output](docs/screenshot.png)
-->

![xdl CLI](docs/screenshot.svg)
